...
{
	internal class FlumeNode
	{
        public FlumeNode(FlumeNodeConfig nodeDefinition)
		{
			...
			ConnectionProvider = new ConnectionPool(nodeDefinition.Host, nodeDefinition.Port,nodeDefinition.PoolSize,nodeDefinition.ConnectionLifetimeMinutes);
		}
