h1. Flume .NET Agent (thrift client)
...
collector_name2 : thriftSource( 2014 )| collectorSink("hdfs://localhost/flume/%{catalog}/2012", "",5000,raw());
</pre>
and then map the collector to the physical node,
...
ps: suppose the ip and node name is mapped as:
your_physical_node_name1 == 10.1.1.125
your_physical_node_name2 == 10.1.1.122
